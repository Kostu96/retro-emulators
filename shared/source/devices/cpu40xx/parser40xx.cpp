...
namespace ASM40xx {
        ...
        m_line{ 1 }
    {
        ...
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "P0" }, 0x0);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "P1" }, 0x2);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "P2" }, 0x4);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "P3" }, 0x6);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "P4" }, 0x8);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "P5" }, 0xA);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "P6" }, 0xC);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "P7" }, 0xE);

        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R0" }, 0x0);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R1" }, 0x1);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R2" }, 0x2);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R3" }, 0x3);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R4" }, 0x4);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R5" }, 0x5);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R6" }, 0x6);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R7" }, 0x7);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R8" }, 0x8);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R9" }, 0x9);

        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "RA" }, 0xA);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "RB" }, 0xB);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "RC" }, 0xC);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "RD" }, 0xD);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "RE" }, 0xE);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "RF" }, 0xF);

        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R10" }, 0xA);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R11" }, 0xB);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R12" }, 0xC);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R13" }, 0xD);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R14" }, 0xE);
        m_symbolTable.emplace<std::string_view, u16>(std::string_view{ "R15" }, 0xF);
    }
    ...
    void Parser::instruction()
    {
        ...
        case Token::Type::MN_ADD: {
            ...
            m_output.push_back(0x80 | (reg & 0xF));
            m_address++;
        } break;
        ...
        case Token::Type::MN_BBL: {
            ...
            m_output.push_back(0xC0 | (value & 0xF));
            m_address++;
        } break;
        ...
        case Token::Type::MN_FIM: {
            ...
            m_output.push_back(0x20 | (reg & 0xFF));
        ...
        case Token::Type::MN_FIN: {
            ...
            m_output.push_back(0x30 | (reg & 0xF));
            m_address++;
        } break;
        ...
        case Token::Type::MN_INC: {
            ...
            m_output.push_back(0x60 | (reg & 0xF));
            m_address++;
        } break;
        case Token::Type::MN_ISZ: {
            ...
            m_output.push_back(0x70 | (reg & 0xF));
            m_output.push_back(value & 0xFF);
            m_address += 2;
        } break;
        ...
        case Token::Type::MN_JIN: {
            ...
            m_output.push_back(0x31 | (reg & 0xF));
            m_address++;
        } break;
        ...
        case Token::Type::MN_LD: {
            ...
            m_output.push_back(0xA0 | (reg & 0xF));
            m_address++;
        } break;
        ...
        case Token::Type::MN_SRC: {
            ...
            m_output.push_back(0x21 | (reg & 0xF));
            m_address++;
        } break;
        ...
        case Token::Type::MN_SUB: {
            ...
            m_output.push_back(0x90 | (reg & 0xF));
            m_address++;
        } break;
