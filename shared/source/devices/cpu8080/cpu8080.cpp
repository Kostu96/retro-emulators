...
{
    u16 result = A + value + F.Carry;
    u8 result4bit = (A & 0xF) + (value & 0xF) + F.Carry;
    A = result & 0xFF;
...
void CPU8080::CMP(u8 value)
{
    ...
    u8 result4bit = (s8)(A & 0xF) - (s8)(value & 0xF);
...
{
    u16 result = (s16)A - (s16)value - F.Carry;
    u8 result4bit = (s8)(A & 0xF) - (s8)(value & 0xF) - F.Carry;
    A = result & 0xFF;
